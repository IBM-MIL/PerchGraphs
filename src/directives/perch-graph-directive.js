...
/**
 *  @class PerchGraphs.PerchGraphController
 *  @memberOf PerchGraphs
 *
 *  @description
 ...
 */
angular.module('mil.PerchGraphs').controller('PerchGraphController', function($element, $scope) {
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.onStart
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.onRestart
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.onStop
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.newPerchGraphStrategy
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.onPanStart
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.onPanMove
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.onPanStop
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.bind
   *
   *  @description
  ...
  function bind() {
    ...
    // Set up scales
    if (_data.length < 2) {
      _strategy.x().domain([_data[0].x, _data[0].x]);
      _strategy.x().range([_data[0].x * _strategy.delta(), _data[0].x * _strategy.delta()]);
    } else {
    ...
    _xAxis = d3.svg.axis()
              ...
              .orient('bottom')
              .tickSize(0)
              .tickValues(_data.map(function(d) {
                return d.x;
              }))
              .ticks(_data.length);
    ...
    _axisGroup = _svg.append('g')
                     ...
                     .attr('transform', 'translate(0,' + (_height - _axisGutter + _axisOffset) + ')');3
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.bindAxisMask
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.snap
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.snapTo
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.moveTo
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.updateDomain
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.invalidate
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.showScrubber
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.hideScrubber
   *
   *  @description
  ...
  /**
   *  @function PerchGraphs.PerchGraphController.findClosestIndex
   *
   *  @description
 ...
 *  @copyright © 2015 IBM Corporation. All Rights Reserved.
 */
angular.module('mil.PerchGraphs').directive('perchGraph', function() {
